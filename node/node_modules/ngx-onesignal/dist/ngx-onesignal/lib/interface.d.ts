...
export interface OneSignalStub {
    ...
    isPushNotificationsEnabled: (cb?: (isEnabled: boolean) => void) => Promise<boolean>;
 ...
 */
export declare abstract class OneSignalOptions {
    appId: string;
