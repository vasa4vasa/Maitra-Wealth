...
export class EditdialogComponent implements AfterViewInit,OnInit{
 ...
 currentDate :Date = new Date();
  ...
  constructor(private fbuild : FormBuilder, private http: HttpClient, private dialogRef: MatDialogRef<EditdialogComponent>,
  ...
  submitData() {
    ...
    if (this.empform.valid) {
      let bodyData = {
        ...
        "updated_on": this.datePipe.transform(this.currentDate, 'yyyy-MM-dd')
      };
